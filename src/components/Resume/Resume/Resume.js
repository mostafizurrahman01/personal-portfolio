        ...
        <div>
            ...
            <>
                                    ...
                                    {ResumeData.experiences.map((experience) => (
                                        <TimelineItem>
                                            ...
                                            <TimelineContent className="timeline_content">
                                                ...
                                                <Typography variant='body2' className="timeline_experience">{experience.description}</Typography>
                                            </TimelineContent>
                                        </TimelineItem>
                                    ))}
                                </CustomTimeline>
                                    ...
                                    {ResumeData.education.map((education) => (
                                        <TimelineItem>
                                            ...
                                            <TimelineContent className="timeline_content">
                                                ...
                                                <Typography variant='caption' className="timeline_date">{education.description}</Typography>
                                                <Typography variant='body2' className="timeline_experience">{education.date}</Typography>
                                            </TimelineContent>
                                        </TimelineItem>
                                    ))}
                                </CustomTimeline>
                ...
                <Grid container className="section">
                    ...
                    <Grid item xs={12} className="ms-5 mt-5">
                        <Grid container spacing={3} justify='space-around'>
                            {ResumeData.projects.map(project => (
                                <Grid item sm={6} xs={12} md={3}>
                                    <div className="project">
                                        <img className="project_img" src={project.img} alt="" />
                                        <Typography className="project_title" variant='h6'>{project.title}</Typography>
                                        <Typography className="project_details" variant='body2'>{project.details}</Typography>
