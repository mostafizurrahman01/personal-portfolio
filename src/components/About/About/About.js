...
const About = () => {
    return ( < div >
            ...
            md = { 6 } >
            <
            CustomTimeline title = "My Identity"
            icon = { < WorkIcon / > } > {
                ResumeData.owner.map(info => ( <
                    ...
                    className = "timeline_date" > { info.birthday } < /Typography> <
                    br / >
                    <
                    Typography variant = 'caption'
                    className = "timeline_date" > { info.email } < /Typography> <
                    br / >
                    <
                    Typography variant = 'caption'
                    className = "timeline_date" > { info.phone } < /Typography> <
                    br / >
                    <
                    Typography variant = 'body2'
                    className = "timeline_experience" > { info.address } < /Typography> < /
                    TimelineContent > <
                    /TimelineItem>
                ))
            } <
    ...
    justify = 'space-evenly' >
        <
        a href = "https://drive.google.com/file/d/1xEornfP5ozKNC7uwqOcwrmsqD9OED3is/view?usp=sharing"
    className = "btn-main" >
        <
